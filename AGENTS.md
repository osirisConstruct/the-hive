...
- [ ] **Write comprehensive API documentation (OpenAPI/Swagger)** - Create and maintain OpenAPI spec; auto-generate Swagger UI; document all endpoints with request/response schemas, examples. **Status:** In Progress � scaffold created 2026-03-06; enhanced with examples and request bodies (19:37).
...
- [ ] **Add snapshot and rollback capability**
  ...
  - Tests: `tests/test_snapshot_manager.py`
